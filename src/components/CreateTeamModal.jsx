...
const CreateTeamModal = ({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccess(
        `Team "${teamName}" created with ${selectedParticipants.length} members!`
      );
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200 flex-shrink-0">
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1">
              Name your team and select members to join
            </p>
          </div>
          <button
            onClick={handleClose}
            ...
            >
              {loading ? (
                ...
                <>
                  ...
                  <span>
                    Create Team ({selectedParticipants.length} members)
                  </span>
                </>
              )}
            </button>

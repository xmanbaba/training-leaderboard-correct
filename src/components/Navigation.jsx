...
import { BarChart3, Trophy, Plus, Users, Settings, ChevronLeft, Flame } from 'lucide-react';
...
const Navigation = ({ collapsed, setCollapsed }) => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className={`fixed left-0 top-0 h-full bg-white/90 backdrop-blur-xl border-r border-blue-200/50 shadow-xl transition-all duration-300 z-50 ${
        ...
        <div className="p-6 border-b border-blue-100/50">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="hidden lg:flex p-2 text-gray-400 hover:text-blue-600 hover:bg-blue-50 rounded-xl transition-all duration-200"
            >
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                `group relative flex items-center space-x-3 p-3 rounded-xl transition-all duration-200 ${
                  isActive 
                    ? 'bg-gradient-to-r from-blue-50 to-indigo-50 text-blue-700 shadow-lg scale-105' 
          ...
          {!collapsed && (
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-4 rounded-xl border border-blue-200/50">
              <div className="text-center">
                <div className="w-12 h-12 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-xl mx-auto mb-2 flex items-center justify-center">
                  <Trophy className="h-6 w-6 text-white" />
                </div>
                <h4 className="font-semibold text-gray-900 text-sm">Training Progress</h4>
                <p className="text-xs text-gray-600 mb-3">Complete all modules</p>
